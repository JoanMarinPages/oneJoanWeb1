...
export function Hero() {
  return (
    <section id="hero" className="relative w-full min-h-[calc(100vh-5rem)] flex items-center">
        <div className="absolute inset-0 bg-grid-pattern opacity-5" />
        <div className="container relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6 items-start text-left fade-in-up">
                ...
                <div className="flex gap-8 mt-6 pt-6 border-t w-full">
                    <div>
                     ...
                     <div>
                        ...
                        <p className="text-muted-foreground">Años Exp.</p>
                    </div>
                     <div>
         ...
         <div className="absolute bottom-10 left-1/2 -translate-x-1/2 mt-16 fade-in-up" style={{ animationDelay: '800ms' }}>
