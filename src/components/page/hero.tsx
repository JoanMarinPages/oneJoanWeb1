...
export function Hero() {
  return (
    <section id="hero" className="relative w-full min-h-[calc(100vh-5rem)] flex items-center justify-center text-center overflow-hidden">
        <div className="absolute inset-0 bg-grid-pattern opacity-5" />
        <div className="container relative z-10 flex flex-col items-center justify-center py-20 md:py-32">
        <div className="fade-in-up">
            <Badge variant="outline" className="mb-6 border-primary/50 text-primary text-sm py-1 px-4 rounded-full font-semibold bg-primary/10">
        ...
        <div className="mt-12 flex flex-col items-center gap-6 fade-in-up" style={{ animationDelay: '400ms' }}>
            <div className="relative group">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-primary to-accent rounded-full blur-lg opacity-60 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                <Card className="relative p-6 flex flex-col items-center gap-4 bg-card/80 backdrop-blur-sm rounded-2xl shadow-lg border-border/50">
